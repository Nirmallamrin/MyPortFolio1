      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-20">
          ...
          <p className="text-slate-400 max-w-lg mx-auto">
            Sharing my thoughts, experiences, and tutorials on modern web
            technologies.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post) => (
            <div
              key={post.id}
              className="glass-card flex flex-col group overflow-hidden p-0 border-white/5 h-full hover:border-green-500/20"
            >
